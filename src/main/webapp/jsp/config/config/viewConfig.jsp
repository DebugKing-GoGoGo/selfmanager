                ...
                <form class="layui-form layui-form-pane" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input disabled type="text" id="typeName" name="typeName" required  lay-verify="required" 
                                placeholder="请输入分组名称" autocomplete="off" class="layui-input layui-bg-gray">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input disabled type="text" id="groupId" name="groupId" required  lay-verify="required" 
                                placeholder="请输入分组ID" autocomplete="off" class="layui-input layui-bg-gray">
                        </div>
                    </div>  
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input disabled type="text" id="groupName" name="groupName" required  lay-verify="required" 
                                placeholder="请输入分组名称" autocomplete="off" class="layui-input layui-bg-gray">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input disabled type="text" id="propertyId" name="propertyId" required  lay-verify="required" 
                                placeholder="请输入属性ID" autocomplete="off" class="layui-input layui-bg-gray">
                        </div>
                    </div>  
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input disabled type="text" id="propertyName" name="propertyName" required  
                                lay-verify="required" placeholder="请输入属性名称" autocomplete="off" 
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input disabled type="text" id="propertyValue" name="propertyValue" required  
                                lay-verify="required" placeholder="请输入属性值" autocomplete="off" 
                                class="layui-input layui-bg-gray">
                        </div>
                    </div>
