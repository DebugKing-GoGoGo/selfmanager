                ...
                <form class="layui-form layui-form-pane" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" disabled id="author" name="author" required  lay-verify="required" 
                                placeholder="请输入作者" autocomplete="off" class="layui-input layui-bg-gray">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">书名</label>
                        <div class="layui-input-block">
                            <input type="text" disabled id="bookName" name="bookName" required  lay-verify="required" 
                                placeholder="请输入书名" autocomplete="off" class="layui-input layui-bg-gray">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" pane>
                        <div class="layui-inline"id="multiCheckboxLine">
                            ...
                            <div disabled class="layui-input-inline layui-bg-gray" id="multiCheckbox" 
                                style="height: 150px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item layui-form-text pane">
                        ...
                        <div class="layui-input-block">
                            <textarea rows="10"  id="readingThinking" disabled name="readingThinking" 
                                placeholder="请输入内容" class="layui-textarea layui-bg-gray"></textarea>
                        </div>
                    </div>
