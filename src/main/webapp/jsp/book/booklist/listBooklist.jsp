		                ...
		                <form class="layui-form layui-form-pane" action="">
		                    ...
		                    <div class="layui-row layui-form-item pane">
		                        ...
		                        <div class="layui-inline">
			                        <label class="layui-form-label">作者/书名关键字</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="bookName" placeholder="请输入作者/书名关键字" 
        ...
        <script>
			function pageScript(params) {
				...
				var dataTable = table.render({
					elem: "#dataTable"
			        ,height: "full-320"
			        ,url: common.url.booklist.list
			        ,page: true
				    ,cols: [[
				        {field: "id", title: "ID", width: 70, unresize: true}
				        ,{field: "bookName", title: "书名", width: 260}
				        ,{field: "author", title: "作者", width: 140}
				        ,{field: "readingThinking", title: "读后感", width: 79}
				        ,{field: "tagNames", title: "标签", width: 341}
				        ,{fixed: "right", field: "discard", title: "状态", width: 100, templet: "#discardTpl", unresize: true}
				        ,{fixed: "right", title: "操作", width: 140, align: "center", toolbar: "#menuTpl", unresize: true}
				    ]]
				    ,where: {
				...
				form.on("submit(search)", function(data) {
				    dataTable.reload({
				        where: { 
				        	multiCheckbox: globals.configIds // 标签
