            ...
            <div class="layui-row">
                <form class="layui-form layui-form-pane" action="">
                    ...
                    <div class="layui-form-item pane">
                        <label class="layui-form-label">写于日期</label>
                        <div class="layui-input-inline">
                            <input placeholder="请选择写于日期" required  lay-verify="required" type="text" 
                    ...
                    <div class="layui-form-item layui-form-text pane">
                        ...
                        <div class="layui-input-block">
                            <textarea rows="10" id="afterReadFeeling" name="afterReadFeeling" placeholder="请输入读后感" 
                                class="layui-textarea"></textarea>
                        </div>
                    </div>
