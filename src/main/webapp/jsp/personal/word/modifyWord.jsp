            ...
            <div class="layui-row">
                <form class="layui-form layui-form-pane" action="">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                              <select id="likePercent" name="likePercent" lay-verify="required">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" id="fromWho" name="fromWho" required  lay-verify="required" 
                                placeholder="请输入来自" autocomplete="off" class="layui-input">
                        </div>
                    </div>
