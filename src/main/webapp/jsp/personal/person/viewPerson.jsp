                ...
                <form class="layui-form layui-form-pane" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input disabled type="text" id="name" name="name" required  lay-verify="required" 
                                placeholder="请输入来自" autocomplete="off" class="layui-input layui-bg-gray">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" pane="">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" id="man" name="sex" value="1" title="男">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input disabled type="text" id="type" name="type" required  lay-verify="required" 
                                placeholder="请输入来自" autocomplete="off" class="layui-input layui-bg-gray">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input disabled type="text" id="home" name="home" required  lay-verify="required" 
                                placeholder="请输入来自" autocomplete="off" class="layui-input layui-bg-gray">
                        </div>
                    </div>
