		                    ...
		                    <div class="layui-form-item pane">
		                        ...
		                        <div class="layui-inline">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="taskName" placeholder="请输入任务关键字" 
	        ...
	        function pageScript(params) {
				...
				var dataTable = table.render({
				    ...
				    ,cols: [[
				        ...
				        ,{field: "taskName", title: "任务名称 ", width: 212}
				        ,{field: "step", title: "步骤", width: 444}
				        ,{fixed: "right", title: "是否启用", width: 100, templet: "#discardTpl", unresize: true}
