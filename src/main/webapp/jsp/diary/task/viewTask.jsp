            ...
            <div class="layui-row">
                <form class="layui-form layui-form-pane" action="">
                    ...
                    <div class="layui-form-item">
	                    <div class="layui-inline">
	                        ...
	                        <div class="layui-input-block">
	                          <select name="privilege" disabled id="privilege" lay-verify="required" class="layui-bg-gray">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" disabled id="defaultTime" name="defaultTime" required  
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" disabled id="taskName" name="taskName" required  
                    ...
                    <div class="layui-form-item layui-form-text pane">
                        ...
                        <div class="layui-input-block">
                            <textarea rows="10" id="step" disabled name="step" placeholder="请输入步骤" 
