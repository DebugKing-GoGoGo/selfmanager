                ...
                <form class="layui-form layui-form-pane" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input disabled type="text" id="weather" name="weather" required  
                                lay-verify="required" placeholder="请输入天气" autocomplete="off" 
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input disabled type="text" id="place" name="place" required  
                                lay-verify="required" placeholder="请输入日记地点" autocomplete="off" 
                                class="layui-input layui-bg-gray">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" pane>
                        ...
                        <div class="layui-input-block">
                            <input disabled type="text"  id="mood" name="mood" required  
                                lay-verify="required" placeholder="请输入心情" autocomplete="off" 
                                class="layui-input layui-bg-gray">
                        </div>
                    </div>
